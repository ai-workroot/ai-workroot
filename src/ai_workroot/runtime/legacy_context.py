#!/usr/bin/env python3
"""Compatibility local Context Guide builder for AI Workroot."""
...
from ai_workroot.indexing.legacy_candidates import ContextCandidate, candidate_from_row, mark_candidates_used
from ai_workroot.indexing.legacy_fts import search_fts
from ai_workroot.runtime.paths import workroot_sqlite_path
from ai_workroot.runtime.state import read_jsonl
from ai_workroot.storage.legacy_sqlite import open_sqlite
