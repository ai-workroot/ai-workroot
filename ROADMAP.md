...
- Provide Codex and Claude Code entrypoints.
- Provide a minimal file-first starter structure.
- Keep the public seed free of user-specific history.
- Add a polished first-use guide.
- Finalize the kernel implementation specification for the `.workroot/` kernel.
- Finalize the user interaction contract.
- Validate ordinary-user onboarding and first useful preserved result.
- Add export/backup guidance.
...
- Optional graph index integration.
- Website at `aiworkroot.com`.
- Adapter packages for different agents.
