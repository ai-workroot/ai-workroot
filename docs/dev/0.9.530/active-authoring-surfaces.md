...
|---|---|---|---|
| Work | `ai_workroot.work.operations` | `create_task`, `record_agent_run`, `record_work_action`, `create_checkpoint`, `record_invalidation` | Writes active Work records and index invalidations. |
| Handoff | `ai_workroot.handoff.operations` | `create_handoff` | Writes derived transfer packages and invalidates handoff indexes. |
