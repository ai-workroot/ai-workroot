...
```text
src/ai_workroot/core/release.py
...
- Files likely affected: `src/ai_workroot/indexing/providers/release_provider.py`.
...
- Files likely affected: `src/ai_workroot/indexing/providers/candidate_provider.py`.
...
- Files likely affected: `src/ai_workroot/indexing/providers/relationship_provider.py`, `src/ai_workroot/runtime/context.py`.
