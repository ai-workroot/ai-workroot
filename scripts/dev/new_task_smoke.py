...
MODULE_PATH = SRC / "ai_workroot" / "runtime" / "legacy_seed" / "task_creation.py"
spec = importlib.util.spec_from_file_location("task_creation", MODULE_PATH)
if spec is None or spec.loader is None:
    raise SystemExit("cannot load task_creation.py")
