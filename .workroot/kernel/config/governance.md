...
AI Workroot should protect the subject's continuity, privacy, and ownership.

The user's past and knowledge belong to the user, not to the tool.

## Subject Boundary

A Workroot serves one defined subject.
...
The user also has the right to release parts of the past from active recall. AI Workroot should not force painful context to remain active after the user has learned from it and chosen to move forward.
